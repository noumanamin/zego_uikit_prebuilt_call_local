...
// Project imports:
import 'package:zego_uikit_prebuilt_call_local/src/call_config.dart';
import 'package:zego_uikit_prebuilt_call_local/src/call_defines.dart';
import 'package:zego_uikit_prebuilt_call_local/src/zgeo_app_utils.dart';

import '../call_invitation/internal/assets.dart';
import 'member/custom_button_widget.dart';
...
class _ZegoBottomMenuBarState extends State<ZegoBottomMenuBar> {
          ...
          child: ZegoMoreButton(menuButtonListFunc: () {
            List<Widget> buttonList = [
              ...getDefaultButtons(context, cameraDefaultValueFunc: () {
                ...
                return ZegoUIKit()
                    .getMicrophoneStateNotifier(ZegoUIKit()
                    .getLocalUser()
                    .id)
                    .value;
              }),
  ...
  Widget generateDefaultButtonsByEnum(BuildContext context,
    ...
    switch (type) {
      ...
      case ZegoMenuBarButtonName.inviteCallButton:
        return CustomButtonWidget(
          icon: PrebuiltCallImage.asset(PrebuiltCallIconUrls.callInvitation),
          onPressed: () async {
            await share();
          },
        );
  ...
  Future<void> share() async {
    ...
    await FlutterShare.share(
        ...
        text: ZegoAppUtils.sharePayLoad,
